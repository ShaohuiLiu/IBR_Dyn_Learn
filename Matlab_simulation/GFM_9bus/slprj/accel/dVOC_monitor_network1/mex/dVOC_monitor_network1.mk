...
MODEL                   = dVOC_monitor_network1
MODULES                 = dVOC_monitor_network1_acc.c dVOC_monitor_network1_acc_data.c rtGetInf.c rtGetNaN.c rt_look.c rt_look1d.c rt_nonfinite.c c_mexapi_version.c
PRODUCT                 = $(RELATIVE_PATH_TO_ANCHOR)/dVOC_monitor_network1_acc.mexa64
MAKEFILE                = dVOC_monitor_network1.mk
MATLAB_ROOT             = /usr/local/MATLAB/R2023b
ALT_MATLAB_ROOT         = /usr/local/MATLAB/R2023b
START_DIR               = /mnt/Data1/Dyn_learning/Matlab_simulation/GFM_9bus
S_FUNCTIONS_LIB         = 
NUMST                   = 4
NCSTATES                = 123
COMPUTER                = GLNXA64
...
SYSTEM_LIBS             = -L"/usr/local/MATLAB/R2023b/bin/glnxa64" -lmwipp -lut -lmwmathutil -lmwsl_simtarget_instrumentation -lmwsl_simtarget_core -lmwsl_fileio -lmwsigstream -lmwslexec_simlog -lmwsl_AsyncioQueue -lmwsf_runtime -lmwsimulink -lmwslexec_simbridge -lmwstringutil -lemlrt -lmwslio_core -lmwslio_clients -lmwsl_services -lmx -lmex
...
MODELLIB                  = dVOC_monitor_network1_acc.mexa64
MODELREF_LINK_LIBS        = 
...
ADD_INCLUDES = \
	-I$(START_DIR) \
	-I$(START_DIR)/slprj/accel/dVOC_monitor_network1 \
...
dVOC_monitor_network1_acc.o : $(START_DIR)/slprj/accel/dVOC_monitor_network1/dVOC_monitor_network1_acc.c
	$(CC) -c $(CFLAGS) $(GCC_WALL_FLAG_MAX) $(START_DIR)/slprj/accel/dVOC_monitor_network1/dVOC_monitor_network1_acc.c

dVOC_monitor_network1_acc_data.o : $(START_DIR)/slprj/accel/dVOC_monitor_network1/dVOC_monitor_network1_acc_data.c
	$(CC) -c $(CFLAGS) $(GCC_WALL_FLAG_MAX) $(START_DIR)/slprj/accel/dVOC_monitor_network1/dVOC_monitor_network1_acc_data.c

rtGetInf.o : $(START_DIR)/slprj/accel/dVOC_monitor_network1/rtGetInf.c
	$(CC) -c $(CFLAGS) $(GCC_WALL_FLAG_MAX) $(START_DIR)/slprj/accel/dVOC_monitor_network1/rtGetInf.c

rtGetNaN.o : $(START_DIR)/slprj/accel/dVOC_monitor_network1/rtGetNaN.c
	$(CC) -c $(CFLAGS) $(GCC_WALL_FLAG_MAX) $(START_DIR)/slprj/accel/dVOC_monitor_network1/rtGetNaN.c

rt_look.o : $(START_DIR)/slprj/accel/dVOC_monitor_network1/rt_look.c
	$(CC) -c $(CFLAGS) $(GCC_WALL_FLAG_MAX) $(START_DIR)/slprj/accel/dVOC_monitor_network1/rt_look.c

rt_look1d.o : $(START_DIR)/slprj/accel/dVOC_monitor_network1/rt_look1d.c
	$(CC) -c $(CFLAGS) $(GCC_WALL_FLAG_MAX) $(START_DIR)/slprj/accel/dVOC_monitor_network1/rt_look1d.c

rt_nonfinite.o : $(START_DIR)/slprj/accel/dVOC_monitor_network1/rt_nonfinite.c
	$(CC) -c $(CFLAGS) $(GCC_WALL_FLAG_MAX) $(START_DIR)/slprj/accel/dVOC_monitor_network1/rt_nonfinite.c
